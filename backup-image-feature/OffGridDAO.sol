...
contract OffGridDAO {
    ...
    function createProposal(string memory _title, string memory _description, string memory _category, uint256 _fundsRequested, string memory _imageUrl) public {
        proposalCount++;
